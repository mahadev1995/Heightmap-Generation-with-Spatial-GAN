...
class Generator1024(keras.Sequential):

    def __init__(self, generator_input_shape=(4, 4 ,4), kernel_size=(3, 3)):
        super(Generator1024, self).__init__(name="generator1024")
        # Block-1
        self.add(keras.layers.Conv2D(1024, kernel_size,
        ...
        self.add(keras.layers.Conv2D(512, kernel_size, padding='same', use_bias=True))
        self.add(keras.layers.BatchNormalization())
